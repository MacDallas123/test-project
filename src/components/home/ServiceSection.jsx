  ...
  const popularMeals = [
    {
      ...
      description:
        "Poulet mariné au citron avec oignons caramélisés, accompagné de riz blanc",
      image: Plat1,
    ...
    },
    {
      ...
      description:
        "Steak haché 180g, cheddar fondu, bacon croustillant et sauce maison",
      image: Plat2,
      tags: ["Nouveau"],
    },
    {
  ...
  const otherServices = [
    {
      ...
      description:
        "Mettez en relation restaurateurs et professionnels de la restauration. Des centaines d'offres d'emploi disponibles dans toute la ville.",
    ...
    },
    {
      ...
      description:
        "Suite d'outils dédiée aux restaurateurs pour optimiser la gestion de votre établissement, des commandes à la comptabilité.",
        ...
        <div className="max-w-3xl mx-auto mb-16 text-center">
          ...
          >
            ...
            <p className="text-gray-600">
              Des plats délicieux et des services complets pour une expérience
        ...
        <div className="mb-16">
          <div className="flex flex-wrap items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-600">
                Découvrez les préférés de nos clients
              </p>
            </div>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div className="flex flex-col transition bg-white border shadow-sm rounded-xl hover:shadow-md">
              ...
              <div className="flex flex-col flex-1 p-4">
                ...
                <h4 className="mb-2 text-lg font-bold">
                  5 astuces pour optimiser vos commandes à emporter
                </h4>
                <p className="flex-1 mb-3 text-gray-600">
                  Découvrez comment gagner du temps et profiter au mieux de
                  notre service de livraison rapide.
                </p>
                <Link
                  to="/blog/optimiser-commandes"
                  className="inline-flex items-center mt-auto font-medium text-primary hover:underline"
                >
                  Lire l'article
            ...
            <div className="flex flex-col transition bg-white border shadow-sm rounded-xl hover:shadow-md">
              ...
              <div className="flex flex-col flex-1 p-4">
                ...
                <h4 className="mb-2 text-lg font-bold">
                  Les plats préférés de nos utilisateurs en 2024
                </h4>
                <p className="flex-1 mb-3 text-gray-600">
                  Un tour d’horizon des saveurs qui font vibrer la communauté
                  LivrerNourriture cette année.
                </p>
                <Link
                  to="/blog/plats-preferes-2024"
                  className="inline-flex items-center mt-auto font-medium text-primary hover:underline"
                >
                  Lire l'article
                  <ArrowRight className="w-4 h-4 ml-1" />
            ...
            <div className="flex flex-col transition bg-white border shadow-sm rounded-xl hover:shadow-md">
              ...
              <div className="flex flex-col flex-1 p-4">
                ...
                <h4 className="mb-2 text-lg font-bold">
                  Bien manger même quand on manque de temps
                </h4>
                <p className="flex-1 mb-3 text-gray-600">
                  Conseils d’experts pour allier rapidité et alimentation
                  équilibrée grâce à la livraison.
                </p>
                <Link
                  to="/blog/manger-vite-bien"
                  className="inline-flex items-center mt-auto font-medium text-primary hover:underline"
                >
                  Lire l'article
                  <ArrowRight className="w-4 h-4 ml-1" />
