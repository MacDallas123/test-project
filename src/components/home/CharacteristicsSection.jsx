...
import { Navigation, Pagination, Autoplay, EffectFade, EffectFlip, EffectCoverflow, EffectCards } from "swiper/modules";
import "swiper/css";
import "swiper/css/navigation";
import "swiper/css/pagination";
import "swiper/css/effect-fade";
import "swiper/css/effect-flip";
import { ArrowRight, Briefcase, CheckCircle, Clock, Euro, Eye, FileCode, FileText, Plus, Rocket, Search, ShieldCheck, ShoppingCart, Sparkles, Star, UserPlus, Users } from "lucide-react";
    ...
    const cards = [
        {
            ...
            description: t("characteristics.security_desc", "Des systèmes fiables pour protéger vos données et vos transactions."),
        },
        {
            icon: Euro,
            title: t("characteristics.transparent_prices", "Prix Transparents"),
            description: t("characteristics.transparent_prices_desc", "Pas de frais cachés, un devis clair dès le départ pour chaque prestation."),
        },
        {
            icon: Clock,
            title: t("characteristics.fast_delivery", "Rapidité"),
            description: t("characteristics.fast_delivery_desc", "Des délais respectés et des interventions rapides selon vos besoins."),
        },
    ];

    return (
        <section
            className="relative px-4 py-16 overflow-hidden bg-linear-to-br from-primary/10 to-muted/20 md:px-8"
        >
                            ...
                            >
                                <Card className="flex flex-col items-center bg-white/90 dark:bg-background/70 rounded-xl shadow-xl px-6 py-8 text-center transition transform hover:scale-[1.035] hover:shadow-2xl backdrop-blur h-full">
                                    ...
                                    <CardHeader className="w-full">
                                        <CardTitle className="mb-2 text-xl font-semibold">{card.title}</CardTitle>
