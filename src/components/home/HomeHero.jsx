...
import { ArrowRight, LogIn, UserPlus, Mail, Home, Clock, Heart, Star } from "lucide-react";
...
const HomeHero = () => {
    ...
    const slides = [
        ...
        },
        {
            ...
            subtitle: "En quelques clics, votre repas est en route. Suivi en temps réel, paiement sécurisé.",
        ...
        },
        {
            ...
            subtitle: "Burgers, pizzas, plats locaux, options healthy… il y a toujours quelque chose pour vous.",
        ...
        },
        {
            ...
            subtitle: "Nous travaillons avec des partenaires locaux pour vous offrir qualité et fraîcheur.",
    ...
    const renderSlideContent = (slide) => {
        ...
        return (
            <div className="space-y-6 md:space-y-8">
                {/* Badge */}
                {slide.badge && (
                    <Badge className={`px-4 py-2 text-sm md:text-base font-semibold rounded-full ${colors.badge}`}>
                ...
                <div className="space-y-4">
                    ...
                    >
                        <h1 className="font-bold tracking-tight">
                            ...
                            <span className={`block text-2xl text-secondary md:text-3xl lg:text-4xl bg-linear-to-r bg-clip-text `}>
                                {slide.subtitle}
                            </span>
                        </h1>
                    </motion.div>
                ...
                >
                    ...
                    >
                        <Link to={
                            slide.type === 'step1' ? "/" :
                            slide.type === 'step2' ? "/auth/login" :
                            slide.type === 'step3' ? "/auth/register" :
                            "/contact"
                        }>
                            {slide.type === 'step1' ? 'Commander maintenant' :
                             slide.type === 'step2' ? 'Télécharger l\'app' :
                             slide.type === 'step3' ? "Explorer les restaurants" :
                             'Devenir partenaire'}
