                  ...
                  <ul className="ml-6 space-y-2">
                    ...
                    <li className="flex items-center gap-3">
                      <button
                        ...
                        onClick={() => window.open("https://maps.google.com/?q=51 Rue du Grévarin – 27200 Vernon", "_blank")}
                      >
                      ...
                      <button
                        ...
                        onClick={() => window.open("https://wa.me/33605511432", "_blank")}
                      >
        ...
        <div className="pt-8 border-t border-border/40">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <p className="text-sm font-light text-center text-white/70">
              &copy; {new Date().getFullYear()} <span className="text-2xl text-secondary">L</span>ivrer<span className="text-2xl text-secondary">N</span>ourriture.{" "}
